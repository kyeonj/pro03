...
#id { width:780px; float:left; margin-right:30px;  }
</style>
</head>
<body>
	    ...
	    <div class="columns is-full">
			...
			<div class="column is-10">
				...
				<form name="frm1" id="frm1" action="${path1 }/UserUpdateCtrl.do" method="post" onsubmit="return joinCheck(this)">
					...
					<div class="btn-group">
						<input type="submit" name="submit-btn" class="button is-link is-light" value="회원정보변경">
						<a href="${path1 }" class="button is-link is-light">취소</a>
					</div>
				</form>	
				<script>
