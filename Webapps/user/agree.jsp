...
.agree_fr { width: 1200px; white-space:pre-wrap; margin: 10px auto; 
padding: 24px; border:2px solid #eee; height:600px; overflow-y:auto; }
.form-check  {padding-left: 80px;}
.btn-group {padding-left: 80px;}
</style>
</head>
<body>
...
③ 법 시행 전에 개인정보를 수집한 개인정보처리자는 기존의 수집목적 범위에도 불구하고 제1항 단서 및 제2항을 준수하기 위하여 새롭게 정보주체의 동의를 받을 목적으로 법 시행 전에 수집한 개인정보를 이용할 수 있다.
	...
	<br><hr><br>	
	<div class="btn-group">
		<button type="button" id="in_btn1" class="button is-link is-light"">다음 단계</button>
	</div>
	<script>
