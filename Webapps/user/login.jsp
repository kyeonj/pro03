...
<jsp:include page="/header.jsp" />
  <section class="section">
	...
	<form name="frm1" id="frm1" action="${path1 }/UserLoginCtrl.do" method="post" onsubmit="return joinCheck(this)">
		...
		<div class="btn-group">
			<input type="submit" name="submit-btn" class="button is-link is-light" value="로그인">
			<input type="reset" name="reset-btn" class="button is-link is-light" value="취소">
			<a href="<%=request.getContextPath() %>/user/agree.jsp" class="button is-link is-light">회원가입</a>
		</div>
	</form>	
	<script>
	</script>
