  ...
  <section class="section">
    <div class="container">
      <h1 class="title">장소 상세보기</h1>
		...
		<div class="buttons">
		  <a href="${path1 }/GetTourListCtrl.do" class="button is-link is-light">전체 목록</a>
		  <a href="${path1 }/GetTourCateListCtrl.do?cate=${dto.cate }" class="button is-link is-light">카테고리 목록</a>
		  <c:if test='${sid.equals("admin") }'>
			  <a href="${path1 }/DelTourCtrl.do?no=${dto.no }" class="button is-link is-light">장소 삭제</a>
			  <a href="${path1 }/ModifyTourCtrl.do?no=${dto.no }" class="button is-link is-light">장소 수정</a>
		  </c:if>
		</div>
    </div>
  </section>
